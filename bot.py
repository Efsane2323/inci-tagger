...
GROUP_SUPPORT = os.environ.get("GROUP_SUPPORT", "evrendestek") # Botunuzdan yasaklanan kullanıcıların itiraz işlemleri için başvuracağı grup, kanal veya kullanıcı. Boş bırakırsanız otomatik olarak OWNER_ID kimliğine yönlendirecektir.
...
async def info(event):
  await event.reply("**Merhaba Benim Ve Sahibim Hakkında Bilgi\n\nPython: 3.8.2\nKütüphanem: Telethon\n\nSahibim:  Gruplarınızda Üyeleri Etiketlemek için Yaratılmışım**",
                    buttons=(
                      [
                       Button.url('Beni Grubuna Ekle ➕', 'https://t.me/Tegger_utag_bot?startgroup=a')
                      ],
                      [
                       Button.url('📢 Kanal', 'https://t.me/hababammsinifi'),
...
app.run()
print(">> Bot çalışıyor https://t.me/evrendestek Tarafından Kuruldu<<")
